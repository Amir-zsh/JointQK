...
- Reference: pooled compact8 Σ_Q from
  `artifacts/stage1/cca_vs_waterfill_study/cca_stats_llama31_8b_longbench_compact8_n400.pt`
...
Artifacts:
- Raw metrics: `artifacts/stage1/q_distribution_shift/per_task_drift.json`
- Charts: `notes/stage1/figs/q_drift/{prefill_drift,decode_drift,combined_trajectory,summary_bars}.png`
...
Combining with prior experiments documented in `phase7_v7_results_report.md`,
...
- F1 calibration-coverage sweep (Part 1):
  - `artifacts/stage1/downstream_v7_llama_compact9/` (8 cells with compact9 basis)
  - `artifacts/stage1/downstream_v7_llama_lcconly/` (8 cells with lcc-only basis)
- Σ_Q analysis (this doc):
  - `artifacts/stage1/q_distribution_shift/per_task_drift.json`
  - `notes/stage1/figs/q_drift/*.png`
- Source code:
  - `experiments/stage1/scripts/analyze_q_distribution_shift.py`
  - `experiments/stage1/scripts/capture_decode_q_llama_multi_task.py`
  - `experiments/stage1/scripts/plot_q_distribution_shift.py`
  - `experiments/stage1/scripts/build_calibration_artifacts_from_pool.py` (now
