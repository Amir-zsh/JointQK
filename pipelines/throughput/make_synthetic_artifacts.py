...
under third_party/samuel_vq/codebooks/ or artifacts/oscar_llama31_8b/.

Usage:
  python pipelines/throughput/make_synthetic_artifacts.py --model Qwen/Qwen3-8B
"""
...
from pipelines.throughput.capacity import model_geometry  # noqa: E402
...
def main() -> int:
    ...
    ap.add_argument("--out-root", type=Path,
                    default=REPO / "artifacts/throughput/synthetic")
    ...
    write_rotations(out / "rotations", geom, gen)
