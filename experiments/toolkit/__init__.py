...
from experiments.toolkit.capture import (
    capture_rope_qk,
    run_generation_and_capture,
    run_prefill_qk_post_capture,
    run_prefill_and_capture,
)
from experiments.toolkit.eval import (
    compute_attention_metrics,
    compute_geometry_distortion,
    summarize_metrics,
)
from experiments.toolkit.io import (
    ensure_dir,
    save_json,
    torch_dtype_from_name,
    write_markdown_table,
)
from experiments.toolkit.metric_transform import (
    TRANSFORM_FAMILIES,
...
from experiments.toolkit.model import get_model_device, load_model_and_tokenizer
from experiments.toolkit.moments import (
...
from experiments.toolkit.quantization import (
    Stage1MSECompressor,
