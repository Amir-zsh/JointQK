...
from experiments.benchmarks.evaluate_registry import DATASET_REGISTRY, SCORER_REGISTRY
from experiments.benchmarks.longbench.calculate_metrics import calculate_metrics_e
from experiments.data import build_kvpress_dataset_spec, get_dataset_spec
...
def test_evaluator_end_to_end_smoke(tmp_path: Path):
    ...
    out = subprocess.run(
        [
            sys.executable,
            "-m",
            "experiments.evaluate_generations",
            "--stats_dir",
            str(stats_dir),
        ],
