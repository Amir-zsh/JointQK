...
Usage:
    python -m experiments.tests.regression_fingerprint write \
        --out experiments/tests/baselines/fingerprint_pre.json

    python -m experiments.tests.regression_fingerprint check \
        --baseline experiments/tests/baselines/fingerprint_pre.json \
        [--current experiments/tests/baselines/fingerprint_post.json]
