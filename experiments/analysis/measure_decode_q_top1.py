...
from experiments.calibration.analyze_bases import jointqk_basis
from experiments.calibration.common import RunPaths
from experiments.toolkit.capture import capture_rope_qk
...
def main() -> None:
    ...
    from experiments.calibration.analyze_bases import combine_stats
    ...
    for prompt_meta in chosen:
        ...
        from experiments.data.base import fetch_example
