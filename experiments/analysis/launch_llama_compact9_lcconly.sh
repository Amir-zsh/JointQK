...
EXCLUDE_FILE="${REPO_ROOT}/artifacts/calibration_splits/longbench_compact9_60_seed20260504_2k32k/exclude_train_indices_for_eval.json"

OUT_COMPACT9="${REPO_ROOT}/artifacts/bench_llama_compact9"
OUT_LCCONLY="${REPO_ROOT}/artifacts/bench_llama_lcconly"
LOG_DIR="${REPO_ROOT}/experiments/logs/phase7_v7_llama_compact9_lcconly"
