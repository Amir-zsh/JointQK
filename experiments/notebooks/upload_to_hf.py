...
Usage:
    python experiments/notebooks/upload_to_hf.py \\
...
BUNDLES = {
    "small": {
        "source": Path("artifacts/query_stats_longbench_under4k_small"),
        "repo_suffix": "-small",
    },
    "full": {
        "source": Path("artifacts/query_stats_longbench_under4k"),
        "repo_suffix": "-full",
    },
}
...
def main() -> None:
    ...
    print("\nSet these as SPECS[...]['repo_id'] in experiments/notebooks/longbench_data_tour.ipynb.")
