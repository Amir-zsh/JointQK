...
Walks the kept `artifacts/stage1/downstream_v7*` and
`artifacts/stage1/q_distribution_shift/` trees and emits a single JSON
...
Usage:
    python -m experiments.stage1.tests.regression_fingerprint write \
        --out experiments/stage1/tests/baselines/fingerprint_pre.json

    python -m experiments.stage1.tests.regression_fingerprint check \
        --baseline experiments/stage1/tests/baselines/fingerprint_pre.json \
        [--current experiments/stage1/tests/baselines/fingerprint_post.json]
...
ARTS = REPO / "artifacts" / "stage1"

BENCH_ROOTS = [
    ARTS / "downstream_v7",
    ARTS / "downstream_v7_llama_verify",
    ARTS / "downstream_v7_llama_compact9",
    ARTS / "downstream_v7_llama_lcconly",
]
