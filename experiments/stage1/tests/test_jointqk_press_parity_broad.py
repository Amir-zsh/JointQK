...
def find_one_example_bundle() -> Path:
    base = REPO / "artifacts/stage1/query_stats_longbench_under4k/examples"
...
def main():
    ...
    cca_full_path = REPO / "artifacts/stage1/cca_vs_waterfill_study/cca_stats.pt"
    v_full_path = REPO / "artifacts/stage1/v_method_study/v_stats.pt"
