...
Outputs:
  ...
  notes/stage1/figs/q_drift/prefill_drift.png
  notes/stage1/figs/q_drift/decode_drift.png
  notes/stage1/figs/q_drift/combined_trajectory.png
  notes/stage1/figs/q_drift/summary_bars.png
"""
...
def main():
    ...
    parser.add_argument("--reference-cca",
        default=str(REPO / "artifacts/stage1/cca_vs_waterfill_study/cca_stats_llama31_8b_longbench_compact8_n400.pt"))
    parser.add_argument("--compact8-raw",
        default=str(REPO / "artifacts/stage1/calibration/longbench_compact8_qkv_llama31_8b/01_raw"))
    parser.add_argument("--compact9-raw",
        default=str(REPO / "artifacts/stage1/calibration/longbench_compact9_qkv_llama31_8b/01_raw"))
    ...
    parser.add_argument("--decode-q-dir",
        default=str(REPO / "artifacts/stage1/decode_q_captures_llama"))
    ...
    parser.add_argument("--out", default=str(REPO / "artifacts/stage1/q_distribution_shift/per_task_drift.json"))
