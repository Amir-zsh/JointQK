...
def main():
    ...
    parser.add_argument("--cca-path", default="artifacts/stage1/cca_vs_waterfill_study/cca_stats_llama31_8b_longbench_compact8_n400.pt")
    parser.add_argument("--raw-dir", default="artifacts/stage1/calibration/longbench_compact8_qkv_llama31_8b/01_raw")
    parser.add_argument("--bits", type=int, default=2)
    parser.add_argument("--out", default="artifacts/stage1/calibration/longbench_compact8_qkv_llama31_8b/05_reports/llama_empirical_kmse_top1_top5.json")
