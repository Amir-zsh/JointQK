...
to notes/stage1/jointqk_investigation_report.html.
"""
...
def main():
    # ---- Load data ----
    llama_kmse = json.loads((REPO / "artifacts/stage1/calibration/longbench_compact8_qkv_llama31_8b/05_reports/llama_empirical_kmse_top1_top5.json").read_text())
    qwen3_kmse = json.loads((REPO / "artifacts/stage1/calibration/longbench_compact8_qkv/05_reports/qwen3_empirical_kmse_top1_top5_b2.json").read_text())
    mech = json.loads((REPO / "artifacts/stage1/calibration/mechanism_analysis_bias_attn_kl.json").read_text())
    logit_kl = json.loads((REPO / "artifacts/stage1/calibration/logit_kl_llama_k2.json").read_text())
    traj = json.loads((REPO / "artifacts/stage1/calibration/decode_trajectory_llama_k2.json").read_text())
    drift = json.loads((REPO / "artifacts/stage1/q_distribution_shift/per_task_drift.json").read_text())
    ...
    verify_f1 = read_f1_dir(REPO / "artifacts/stage1/downstream_v7_llama_verify")
    compact9_f1 = read_f1_dir(REPO / "artifacts/stage1/downstream_v7_llama_compact9")
    lcconly_f1 = read_f1_dir(REPO / "artifacts/stage1/downstream_v7_llama_lcconly")

    # Base64 of chart images
    figs_dir = REPO / "notes/stage1/figs/q_drift"
...
<span class="code">notes/stage1/</span> and <span class="code">experiments/stage1/</span>.</p>
...
<p class='muted'>Generated by <span class='code'>experiments/stage1/analysis/build_jq_investigation_html.py</span>.</p>
</body></html>""")

    out_path = REPO / "notes/stage1/jointqk_investigation_report.html"
    out_path.write_text("\n".join(H))
