...
def main():
    ...
    parser.add_argument("--cca", default=str(REPO / "artifacts/stage1/cca_vs_waterfill_study/cca_stats_llama31_8b_longbench_compact8_n400.pt"))
    parser.add_argument("--vst", default=str(REPO / "artifacts/stage1/v_method_study/v_stats_llama31_8b_longbench_compact8_n400.pt"))
    parser.add_argument("--exclude", default=str(REPO / "artifacts/stage1/calibration_splits/longbench_compact8_60_seed20260504_2k32k/exclude_train_indices_for_eval.json"))
    ...
    parser.add_argument("--out", default=str(REPO / "artifacts/stage1/calibration/decode_trajectory_llama_k2.json"))
