...
at `notes/stage1/preview_pooled_n50_report.md`.
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5 \
  .venv/bin/python experiments/stage1/calibration/preview_pooled.py \
  --gpus 0,1,2,3,4,5
```
...
- Split manifest: `artifacts/stage1/calibration_splits/longbench_compact8_60_seed20260504_2k32k/manifest.json`
- Run root: `artifacts/stage1/calibration/longbench_compact8_qkv/`
...
See `notes/stage1/preview_pooled_n50_report.md` for the first results from the post-fix preview.
