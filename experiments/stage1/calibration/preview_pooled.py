...
from experiments.stage1.calibration.common import RunPaths, StatsCache
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--artifact-root", type=Path, default=Path("artifacts/stage1/calibration"))
    ...
    parser.add_argument("--out-dir", type=Path,
                        default=Path("artifacts/stage1/calibration/longbench_compact8_qkv/05_reports/preview_pooled_n50"))
