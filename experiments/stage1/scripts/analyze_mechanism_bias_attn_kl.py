...
Outputs:
  artifacts/stage1/calibration/mechanism_analysis_bias_attn_kl.json
"""
...
from experiments.stage1.toolkit.per_coord_quantization import round_bits_to_integer, PerCoordCompressor
...
def main():
    out_path = REPO / "artifacts/stage1/calibration/mechanism_analysis_bias_attn_kl.json"
    ...
    models = [
        {
            "label": "Qwen3-8B",
            "cca": REPO / "artifacts/stage1/cca_vs_waterfill_study/cca_stats_longbench_compact8_n400.pt",
            "raw": REPO / "artifacts/stage1/calibration/longbench_compact8_qkv/01_raw",
        },
        {
            "label": "Llama-3.1-8B",
            "cca": REPO / "artifacts/stage1/cca_vs_waterfill_study/cca_stats_llama31_8b_longbench_compact8_n400.pt",
            "raw": REPO / "artifacts/stage1/calibration/longbench_compact8_qkv_llama31_8b/01_raw",
        },
    ]
