...
from experiments.stage1.calibration.analyze_bases import (
    combine_stats,
    jointqk_basis,
)
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--artifact-root", type=Path, default=Path("artifacts/stage1/calibration"))
    ...
    p.add_argument("--output-suffix", default="longbench_compact8_n400",
                   help="Suffix attached to the output cca_stats / v_stats filenames. "
                        ...
                        "artifacts/stage1/cca_vs_waterfill_study/cca_stats_longbench_compact8_n400.pt etc.")
    p.add_argument("--cca-out-dir", type=Path,
                   default=Path("artifacts/stage1/cca_vs_waterfill_study"))
    p.add_argument("--v-out-dir", type=Path,
                   default=Path("artifacts/stage1/v_method_study"))
...
def main() -> None:
    ...
    v_artifact = {
        ...
        "metadata": {
            ...
            "prefill_only": True,
            "bundle": f"artifacts/stage1/calibration/{args.run_id} pooled train",
            "version": 2,
        },
    }
