...
Outputs:
  artifacts/stage1/cca_vs_waterfill_study/per_task/cca_stats_<task>.pt
  artifacts/stage1/v_method_study/per_task/v_stats_<task>.pt
"""
...
def main() -> None:
    ...
    for task in tasks:
        out_cca = REPO / f"artifacts/stage1/cca_vs_waterfill_study/per_task/cca_stats_{task}.pt"
        out_v = REPO / f"artifacts/stage1/v_method_study/per_task/v_stats_{task}.pt"
