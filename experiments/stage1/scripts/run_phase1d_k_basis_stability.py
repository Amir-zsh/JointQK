...
from experiments.stage1.toolkit.per_coord_quantization import round_bits_to_integer
...
def main() -> None:
    ...
    p.add_argument("--bundle", default="artifacts/stage1/query_stats_longbench_under4k")
    p.add_argument("--output-dir", default="artifacts/stage1/v_method_study/k_basis_stability")
