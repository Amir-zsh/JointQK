...
# notes/stage1/phase7_v7_llama31_8b_results_report.md (which were produced on a
...
#
# Output: artifacts/stage1/downstream_v7_llama_verify/
...
CCA="${REPO_ROOT}/artifacts/stage1/cca_vs_waterfill_study/cca_stats_llama31_8b_longbench_compact8_n400.pt"
...
OUT_BASE="${REPO_ROOT}/artifacts/stage1/downstream_v7_llama_verify"
LOG_DIR="${REPO_ROOT}/experiments/stage1/logs/phase7_v7_llama_verify"
