...
Output:
  artifacts/stage1/calibration/longbench_compact8_qkv_llama31_8b/05_reports/decode_q_top1_llama.json
"""
...
def main() -> None:
    cca_path = REPO / "artifacts/stage1/cca_vs_waterfill_study/cca_stats_llama31_8b_longbench_compact8_n400.pt"
    raw_root = REPO / "artifacts/stage1/calibration/longbench_compact8_qkv_llama31_8b/01_raw"
    out_path = REPO / "artifacts/stage1/calibration/longbench_compact8_qkv_llama31_8b/05_reports/decode_q_top1_llama.json"
