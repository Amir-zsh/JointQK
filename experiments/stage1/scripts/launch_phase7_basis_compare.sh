...
MODEL="Qwen/Qwen3-8B"
CCA_OLD="${REPO_ROOT}/artifacts/stage1/cca_vs_waterfill_study/cca_stats.pt"
CCA_NEW="${REPO_ROOT}/artifacts/stage1/cca_vs_waterfill_study/cca_stats_longbench_compact8_n400.pt"
VST_OLD="${REPO_ROOT}/artifacts/stage1/v_method_study/v_stats.pt"
...
LOG_DIR="${REPO_ROOT}/experiments/stage1/logs/phase7_basis_compare"
...
# to v6 numbers in `notes/stage1/phase7_v6_results_report.md`.
