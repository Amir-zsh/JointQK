...
`experiments.stage1.toolkit.capture.capture_rope_qk`.

Output: per-task per-prompt .pt file with key 'decode_q' shape (n_layers, n_q_heads, n_steps, d)
saved under artifacts/stage1/decode_q_captures_llama/<task>/row<idx>.pt
"""
...
def main():
    ...
    parser.add_argument("--exclude",
        default=str(REPO / "artifacts/stage1/calibration_splits/longbench_compact8_60_seed20260504_2k32k/exclude_train_indices_for_eval.json"))
    parser.add_argument("--out-dir", default=str(REPO / "artifacts/stage1/decode_q_captures_llama"))
