...
from experiments.stage1.data.kvpress_adapter import (
...
def register_all_benchmark_specs() -> None:
    ...
    Importing experiments.stage1.data alone does not mutate DATASETS.
    """
    from experiments.stage1.data.benchmark_specs import ALL_SPECS
